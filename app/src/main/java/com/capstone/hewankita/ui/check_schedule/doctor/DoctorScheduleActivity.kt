package com.capstone.hewankita.ui.check_schedule.doctor
...
class DoctorScheduleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            rvSchedule.layoutManager = LinearLayoutManager(this@DoctorScheduleActivity)
    ...
    private fun getDoctorService(){
        ...
        databaseReference.child(Constants.TABLE_DATA_SERVICE).child(Constants.CHILD_SERVICE_DOCTOR_SERVICE).orderByChild(Constants.CONST_USER_EMAIL).equalTo(userEmail).addValueEventListener(object : ValueEventListener {
