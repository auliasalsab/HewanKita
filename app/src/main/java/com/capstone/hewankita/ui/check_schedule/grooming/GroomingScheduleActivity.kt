package com.capstone.hewankita.ui.check_schedule.grooming
...
class GroomingScheduleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getString(R.string.grooming_schedule)

        binding.apply {
            rvSchedule.layoutManager = LinearLayoutManager(this@GroomingScheduleActivity)
    ...
    private fun getDoctorService(){
        ...
        databaseReference.child(Constants.TABLE_DATA_SERVICE).child(Constants.CHILD_SERVICE_GROOMING_SERVICE).orderByChild(
