...
class ListConsultant : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            rvConsult.layoutManager = LinearLayoutManager(this@ListConsultant)
    ...
    private fun getOutletData(){
        ...
        databaseReference.child(Constants.TABLE_DATA_USER).orderByChild(Constants.CONST_USER_TYPE).equalTo(Constants.CHILD_USER_PET_SHOP).addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    binding.rvConsult.adapter = ConsultantAdapter(listPetShop)
                }
                else{
