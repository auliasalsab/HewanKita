...
import com.capstone.hewankita.adapter.VaccinationAdapter
...
class VaccinationList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            rvConsult.layoutManager = LinearLayoutManager(this@VaccinationList)
        ...
        databaseReference.child(Constants.TABLE_DATA_USER).orderByChild(Constants.CONST_USER_TYPE).equalTo(
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    binding.rvConsult.adapter = VaccinationAdapter(listPetShop)
                }
                else{
