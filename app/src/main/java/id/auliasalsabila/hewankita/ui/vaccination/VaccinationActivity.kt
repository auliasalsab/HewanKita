package id.auliasalsabila.hewankita.ui.vaccination
...
import id.auliasalsabila.hewankita.databinding.ActivityVaccinationBinding
import id.auliasalsabila.hewankita.ui.outlet.OutletActivity

class VaccinationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getString(R.string.vaccination)
    ...
    override fun onClick(v: View) {
        if(v == binding.tvOutlet) {
            val intent = Intent(this@VaccinationActivity, OutletActivity::class.java)
